    ...
    <section className="product-section">
      ...
      <div className="product-card">
          <img
            ...
            alt="3D printed self-watering planter with a plant in it."
          />
      ...
      <div className="product-card">
          <img
            ...
            alt="3D printed Whistle Blower that makes over 118 decibel."
          />
      ...
      <div className="product-card">
          <img
            ...
            alt="3D printed Pikachu figure that is holding a fishingrow, fishing in a tea cup."
          />
